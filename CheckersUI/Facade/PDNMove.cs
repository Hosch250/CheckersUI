...
namespace CheckersUI.Facade
{
    public class PdnMove
    {
        ...
        public bool IsJump()
        {
            var firstCoord = (Coord)PublicAPI.pdnBoardCoords(Variant.AmericanCheckers.ConvertBack())[Move[0]];
            var secondCoord = (Coord)PublicAPI.pdnBoardCoords(Variant.AmericanCheckers.ConvertBack())[Move[1]];
